...
#fetch https://raw.githubusercontent.com/AndreySinenok/opnazure/dev_active_active/scripts/$1
#fetch https://raw.githubusercontent.com/AndreySinenok/opnazure/master/scripts/$1
